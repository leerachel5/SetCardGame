...
extension SetCardGame.MatchingSet: RangeReplaceableCollection {
    ...
    mutating func replaceSubrange<C>(_ subrange: Range<Index>, with newElements: C) where C : Collection, SetCardGame.MatchingSet.Element == C.Element {
    ...
    mutating func append<S>(contentsOf newElements: S) where S : Sequence, SetCardGame.MatchingSet.Element == S.Element {
